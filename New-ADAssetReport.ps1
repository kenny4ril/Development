...
Function New-ReportDelivery
{
    ...
    END
    {
        if ($Sendmail)
        {
            ...
            if ($ForceAnonymous)
            {
                $Pass = ConvertTo-SecureString â€“String 'anonymous' â€“AsPlainText -Force
...
$UserAttribs = @(
    ...
    'PrimaryGroup',
    'primaryGroupID',
    'PrincipalsAllowedToDelegateToAccoun',
    'ProfilePath',
...
@{
    ...
    6870='Exchange Server 2003 RTM or Exchange Server 2003 SP2'
    6936='Exchange Server 2003 SP3'
    10628='Exchange Server 2007 RTM'
    10637='Exchange Server 2007 RTM'
    11116='Exchange Server 2007 SP1'
    14622='Exchange Server 2007 SP2 or Exchange Server 2010 RTM'
    14625='Exchange Server 2007 SP3'
    ...
    15292='Exchange Server 2013SP1'
    15300='Exchange Server 2013 CU5'
    15303='Exchange Server 2013 CU6'
    15312='Exchange Server 2013 CU7-CU23 w/KB5004778'
    15317='Exchange Server 2016RTM'
    ...
    15333='Exchange Server 2016 CU19-CU20'
    15334='Exchange Server 2016 CU21-CU23'
    17000='Exchange Server 2019 RTM-CU1'
    17001='Exchange Server 2019 CU2-CU7'
    17002='Exchange Server 2019 CU8-CU9'
    17003='Exchange Server 2019 CU10-CU13'    
}
$SchemaHashLync = 
@{
    1006="LCS 2005"
    ...
    1150="Lync Server 2013 or Skype for Business 2015"
}
